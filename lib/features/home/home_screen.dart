      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const _ComingSoonRow(icon: Icons.album_outlined, label: 'Browse albums'),
            const _ComingSoonRow(icon: Icons.workspace_premium_outlined, label: 'My plaques'),
            const _ComingSoonRow(icon: Icons.person_outline, label: 'Profile'),
          ],
        ),
      ),
    );
